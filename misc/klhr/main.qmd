...
institute: "joint work with Barbara Grigg and Chase Wilson"
format:
  revealjs:
    scrollable: true
    code-fold: true
...
* [learn $J$ PCAs](https://www.cse.msu.edu/~weng/research/CCIPCApami.pdf)/eigenvectors $\mathbf{v}_j \in \mathbb{R}^D$ and values $\lambda_j$ during warmup
